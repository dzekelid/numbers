...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/numbers/master/_listings/nxtport/apis.md
...
- name: T-mining Secure Container Release API (live) - Create an Event
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/numbers/master/_listings/nxtport/apiv1events-post-openapi.md
- name: T-mining Secure Container Release API (live) - Create an Event
  x-api-slug: apiv1events-post
  description: |-
    Used to create an event for a container at a specific location and time.
